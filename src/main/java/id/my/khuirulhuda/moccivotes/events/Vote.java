package id.my.khuirulhuda.moccivotes.events;
...
if (spasi) {
  ...
  //String api = "https://minecraft-mp.com/api/?object=votes&element=claim&key="+apikey+"&username="+fname;
} 

      final String api = "https://minecraft-mp.com/api/?object=votes&element=claim&key="+apikey+"&username="+fname;
...
if ( 200 <= responseCode && responseCode <= 299 ) {
  if ( response.contains("1")) {
    ...
    String claimapiurl = "http://minecraft-mp.com/api/?action=post&object=votes&element=claim&key="+apikey+"&username="+fnamee;
